# Adapting from https://github.com/HackerShackOfficial/Automated-Gardener
...
try:
    ...
    print("Error importing RPi.GPIO!  This is probably because you need superuser privileges.  You can achieve thi$
