// works with nodemcu and HX711 with this config https://i.stack.imgur.com/9vDyI.jpg
// remix of https://github.com/newAM/LoadCellOccupany
#include <SPI.h>
...
#define CALIBRATION   -1080 // ADC bits to Kg conversion factor
#define NUM_SAMPLES       20 // number of samples to take per data point
...
#define PRECISION        3   // precision of the result

// connection settings
#define TIMEOUT   5000 // connection failure timeout in ms
#define SER_BAUD  9600 // serial baud rate
#define MQTT_PORT 1883 // MQTT broker port
#define MQTT_CLIENT_ID "occupancy-" // device client ID

// Wifi settings
#define WIFI_CLIENT_ID "CLIENTID"
#define SSID_NAME "WIFINAME" // SSID network wifi name to connect to
#define SSID_PASSWORD "WIFIPASSWORD" // Wifi password

// MQTT topics
#define TOPIC_BASE "occupancy/info" // base topic
...
#define MQTT_HOST IPAddress(XXX, XXX, XXX, XXX) // MQTT broker ip
...
/*debug*/
//                publish string
//                Serial.print("Debug with continuous result: ");
