/**** works on NODEMCU  with custom wired 3x3 matrix and single line matrix LEDs ****/
...
const char* wifi_ssid = "WIFINETWORK"; //type your WIFI information inside the quotes
const char* wifi_password = "WIFIPASSOWRD";
const char* mqtt_server = "MQTTSERVER.ADDRESS";
