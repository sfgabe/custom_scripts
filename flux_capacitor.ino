...
const char* ssid = "WIFI-NETWORK"; //type your WIFI information inside the quotes
...
/**************************** FOR OTA **************************************************/
#define SENSORNAME "flux-capacitor" //change this to whatever you want to call your device
#define OTApassword "OTAPASSWORD" //the password you will need to enter to upload remotely via the ArduinoIDE
int OTAport = 8266;

/************* MQTT TOPICS (change these topics as you wish)  **************************/
const char* light_state_topic = "flux-capacitor/current";
const char* light_set_topic = "flux-capacitor/set";
